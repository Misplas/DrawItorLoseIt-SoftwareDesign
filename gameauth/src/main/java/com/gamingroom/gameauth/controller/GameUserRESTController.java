...
// Added path annotation for GameUsers 
@Path("/gameusers")
...
public class GameUserRESTController {
    ...
    // Added RolesAllowed annotation for USER based on BasicAuth Security Example 
    @RolesAllowed("USER")
    @GET
    @Path("/{id}")
    ...
    // Added RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
    @RolesAllowed("ADMIN")
    @POST
